...
.. table:: 表7-1：常用轻量级标记语言对照
   ...
   |                       |                                             |                                             | 标记语言                    |
   |                       |                                             |                                             +-----+-----+-----+-----+-----+
   |          类别         |  代码示例                                   | 输出示例                                    | MD  | TT  | RST | ASC | ORG |
   +===========+===========+=============================================+=============================================+=====+=====+=====+=====+=====+
   |           | Atx风格   | ::                                          |                                             |     |     |     |     |     |
   |           |           |                                             | 略                                          | md  |     |     |     |     |
   |           |           |   # 一级标题                                |                                             |     |     |     |     |     |
   ...
   |           | 边界风格\ | ::                                          | 三个`符号界定代码块。                       |     |     |     |     |     |
   |           | 和\       |                                             |                                             | gfm |     |     |     |     |
   |           | 语法加亮  |   三个`符号界定代码块。                     | .. code-block:: ruby                        |     |     |     |     |     |
   |           |           |                                             |                                             |     |     |     |     |     |
...
说明：md代表Markdown，gfm代表GitHub风格的Markdown，tt代表Textile，rst代表reStructedText，asc代表aciidoc，org代表Org-mode。
