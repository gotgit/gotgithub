...
.. table:: 表7-1：常用轻量级标记语言对照
   ...
   |                      |   !>/images/github.png!                         |    :align: right                              |     |     |     |     |     |
   |                      |                                                 |                                               |     |     |     |     |     |
   |                      |                                                 | .. |logo| image:: /images/github.png          |     |     |     |     |     |
   |                      |                                                 | .. _logo https://github.com/                  |     |     |     |     |     |
   |                      |                                                 |                                               |     |     |     |     |     |
   +----------------------+-------------------------------------------------+-----------------------------------------------+-----+-----+-----+-----+-----+
   | 表格                 | ::                                              |  .. table::                                   | md  |     |     |     |     |
   |                      |                                                 |     :class: classic                           |     |     |     |     |     |
   ...
   | 其他     | 混用\     | ::                                              |                                               | md  |     |     |     |     |
   |          | HTML      |                                                 |                                               |     |     |     |     |     |
   |          |           |   <div style="background:#bbb;">                | .. class:: test                               |     |     |     |     |     |
   |          |           |     HTML块中不能混用 **标记语法**               |                                               |     |     |     |     |     |
   |          |           |   </div>                                        | HTML块中不能混用 **标记语法**                 |     |     |     |     |     |
   |          |           |                                                 |                                               |     |     |     |     |     |
   |          +-----------+-------------------------------------------------+-----------------------------------------------+-----+-----+-----+-----+-----+
